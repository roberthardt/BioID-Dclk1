...
psite_regulated <- psite_table %>% 
  filter(Site %in% 
           c(Candidates_DSKvsDS$SiteID,
             Candidates_DSKvsK$SiteID,
             Candidates_DSKvsSK$SiteID,
             Candidates_DSvsK$SiteID,
             Candidates_DSvsSK$SiteID,
             Candidates_SKvsK$SiteID))
...
ggpubr::ggbarplot(psite_reg_count, 
                  ...
                  subtitle = "only sites found >=2 in one condition ",
                  xlab = "Construct",
                  ylab = "Count")
